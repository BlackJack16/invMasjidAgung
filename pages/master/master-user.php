...
<?php	
	...
	$cekuser	=mysql_num_rows (mysql_query("SELECT username FROM tb_user WHERE username='$_POST[username]'"));
		...
		if (empty($_POST['username']) || empty($_POST['nama_user']) || empty($_POST['password']) || empty($_POST['hak_akses'])) {
		...
		echo "<div class='register-logo'><b>Oops!</b> username Not Available</div>
			<div class='box box-primary'>
				<div class='register-box-body'>
					<p>Harap periksa kembali dan pastikan username yang Anda masukan benar.</p>
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-master-user' class='btn btn-block btn-warning'>Back</button>
		...
		$insert = "INSERT INTO tb_user (username, nama_user, password, hak_akses, aktif) VALUES ('$username', '$nama_user', '$password', '$hak_akses', 'Y')";
