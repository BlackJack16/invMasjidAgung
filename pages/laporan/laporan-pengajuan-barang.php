<section class="content-header">
    <h1>Laporan <small>Pengajuan Barang</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
			<div class="box box-primary">				
				...
				<div class="box-body">
					...
					<button  name="edit" value="edit" class="btn btn-danger"><a style="color:white" href="pages/laporan/laporan-pengajuan-barang-pdf.php" class="button">Cetak PDF</a></button>
