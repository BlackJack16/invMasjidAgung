...
<body class="hold-transition skin-red fixed sidebar-mini" style="background-color:grey;">
<!-- <body class="hold-transition skin-red fixed sidebar-mini" style="background-image: url('dist/img/masjid_agung.jpg');;background-color:grey;"> -->
<!-- <div class="wrapper"> -->
